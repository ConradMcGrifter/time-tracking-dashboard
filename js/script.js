...
const hours = Array.from(document.querySelectorAll(".hours--wrap"));
...
const fetchData = () => {
    fetch("./data/data.json")
        ...
        .then((json) => {
            ...
            // work data
            const {
                timeframes: { daily: work_Daily, weekly: work_Weekly, monthly: work_Monthly },
            } = json[0];

            // play data
            const {
                timeframes: { daily: play_Daily, weekly: play_Weekly, monthly: play_Monthly },
            } = json[1];

            // study data
            const {
                timeframes: { daily: study_Daily, weekly: study_Weekly, monthly: study_Monthly },
            } = json[2];
            ...
            // social data
            const {
                timeframes: { daily: social_Daily, weekly: social_Weekly, monthly: social_Monthly },
            } = json[4];
            ...
            const setData = (work, play, study, exercise, social, selfCare, str) => {
                ...
                prevExerciseHours.innerText = str + ` - ${exercise.previous}hrs`;
                ...
                prevSelfCareHours.innerText = str + ` - ${selfCare.previous}hrs`;
            };
